...
echo "sistema" > /etc/hostname
sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1	sistema localhost/' /etc/hosts
hostname sistema
...
PASSWORD=$(mkpasswd lJQgi5DlMFO2IbMGJNj4)
...
# Laravel Forge
ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAAAgQCUeysRroLHDyyfVYMX8DyInoVC9sop4Ha+MRiq7SnoYFFUtg4s8bKrIU2PNbT2JdZTL+bURjEGW+ksuc9SFpk8wVru8bmJ8OemCgF6CHBihM7zfOPVzm3OqrbWHUqus6rHPZOj158dxx1bbHJPuDbM0yEfF4j6tj9ksYvy4Nw/Pw== phpseclib-generated-key
EOF
...
git config --global user.name "Ronaldo da Silva Lima"
git config --global user.email "ronal2do@gmail.com"
...
debconf-set-selections <<< "mysql-server mysql-server/root_password password zTyvuq2T57J58GZ0MLL9"
debconf-set-selections <<< "mysql-server mysql-server/root_password_again password zTyvuq2T57J58GZ0MLL9"
...
mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "GRANT ALL ON *.* TO root@'159.203.66.241' IDENTIFIED BY 'zTyvuq2T57J58GZ0MLL9';"
mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "GRANT ALL ON *.* TO root@'%' IDENTIFIED BY 'zTyvuq2T57J58GZ0MLL9';"
service mysql restart

mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "CREATE USER 'forge'@'159.203.66.241' IDENTIFIED BY 'zTyvuq2T57J58GZ0MLL9';"
mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "GRANT ALL ON *.* TO 'forge'@'159.203.66.241' IDENTIFIED BY 'zTyvuq2T57J58GZ0MLL9' WITH GRANT OPTION;"
mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "GRANT ALL ON *.* TO 'forge'@'%' IDENTIFIED BY 'zTyvuq2T57J58GZ0MLL9' WITH GRANT OPTION;"
mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "FLUSH PRIVILEGES;"

# Create The Initial Database If Specified

mysql --user="root" --password="zTyvuq2T57J58GZ0MLL9" -e "CREATE DATABASE forge;"
...
sudo -u postgres psql -c "CREATE ROLE forge LOGIN UNENCRYPTED PASSWORD 'zTyvuq2T57J58GZ0MLL9' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
...
curl --insecure --data "event_id=2499596&server_id=45877&sudo_password=lJQgi5DlMFO2IbMGJNj4&db_password=zTyvuq2T57J58GZ0MLL9" https://forge.laravel.com/provisioning/callback/app
